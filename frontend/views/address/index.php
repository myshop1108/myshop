		...
		<div class="content fl ml10">
			<div class="address_hd">
				...
				<dl class="last"> <!-- 最后一个dl 加类last -->
					<dt><?=$key+1?><?=$address->name?> <?=$address->province?><?=$address->city?> <?=$address->county?><?=$address->address?> <?=$address->mobile?>  </dt>
					<dd>
						<a href="">修改</a>
                        <a href="<?=\yii\helpers\Url::to(['del','id'=>$address->id])?>" id=""del">删除</a>
						<a href="">设为默认地址</a>
					</dd>
				</dl>
<?php endforeach;?>
			...
			<div class="address_bd mt10">
				<h4>新增收货地址</h4>
				<form action="" name="address_form" id="add_from">
                    <input type="hidden" name="_csrf-frontend" value="<?= Yii::$app->request->csrfToken?>">
						<ul>
							...
							<li>
                                ...
                                <select name="Address[county]"></select><br>
							</li>
							<li>
							...
							<li>
								<label for="">&nbsp;</label>
								<input type="checkbox" name="Adress[status]" class="check" />设为默认地址
							</li>
							<li>
								<label for="">&nbsp;</label>
								<input type="button" name="" class="add_btn" value="保存" id="add_btn"/>
							</li>
						</ul>
					</form>
			</div>
...
//提交数据注册
            $.post('/address/add', $('#add_from').serialize(), function (result) {
//                        console.dir(result);
                if (result.status) {
                    alert(result.msg)
//                    console.dir("njjnknj");
