			...
			<div class="summary">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li class="<?=$key>0?"":"cur"?>">
									<a class="<?=$key>0?"":"zoomThumbActive"?>j" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$img->path."?imageView2/2/w/350/h/350"?>',largeimage: '<?=$img->path."?imageView2/2/w/800/h/800"?>'}"><img src="<?=$img->path."?imageView2/2/w/50/h/50"?>"></a>
								</li>
                                <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?=rand(0,9999)?>21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
