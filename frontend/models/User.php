...
//    const SCENARIO_LOGIN = 'login';
    ...
    public function scenarios()
    {
        ...
        $parents['login']=['username','password','rememberMe','checkCode'];
    ...
    public function rules()
    {
        return [
            ...
            [['rePassword','mobile'], 'required','on'=>'reg'],
            [['mobile'],'match','pattern'=>'/(13|14|15|17|18|19)[0-9]{9}/','message'=>'请输入正确的手机号','on'=>'reg'],
            [['username'],'unique','on'=>'reg'],
            ['rePassword','compare','compareAttribute' => 'password'],
            //[['checkCode'],'captcha','captchaAction' => 'user/code','on'=>'reg'],
            //[['checkCode'],'captcha','captchaAction' => 'user/code','on'=>'login'],
